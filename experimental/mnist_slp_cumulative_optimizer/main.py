...
from mindspore_kungfu_debug import CumulativeSGDOptimizer, log_duration, MnistSLP, CumulativeMomentumOptimizer
...
def parse_args():
    ...
    p.add_argument('--ckpt-prefix', type=str, default='mnist-slp')
...
def run(args):
    ...
    net = MnistSLP(num_class=10, num_channel=1)
