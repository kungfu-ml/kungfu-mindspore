#include "backend/kernel_compiler/cpu/kungfu/kungfu_resize_cpu_kernel.h"
...
bool KungFuResizeCPUKernel::Launch(const std::vector<AddressPtr> &inputs,
...
MS_REG_CPU_KERNEL(KungFuResize,
                  KernelAttr()
